...
export class ProductReviewApi {
   ...
   */
  static async getStatistics(productId: string): Promise<ReviewStatisticsResponse> {
   ...
   * Get review detail
   */
  static async getById(productId: string, reviewId: string): Promise<ProductReview> {
   ...
   * Create review
   */
  static async create(productId: string, payload: ProductReviewCreate): Promise<ProductReview> {
