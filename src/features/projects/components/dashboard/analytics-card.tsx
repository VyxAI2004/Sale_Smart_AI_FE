...
export function AnalyticsCard({
  ...
  const getMarketPositionLabel = (position: number) => {
    if (position >= 80)
      return { label: 'Leader', color: 'bg-green-100 text-green-800' }
    if (position >= 60)
        ...
        <CardContent>
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4'>
            ...
            <div className='space-y-2 rounded-lg border p-4'>
              ...
              <p className='text-muted-foreground text-xs'>Products tracked</p>
            </div>
            ...
            <div className='space-y-2 rounded-lg border p-4'>
              ...
              <p
                className={`text-2xl font-bold ${getConfidenceColor(analytics.confidence_score)}`}
              >
                {analytics.confidence_score}%
              </p>
              <p className='text-muted-foreground text-xs'>Analysis accuracy</p>
            </div>
            ...
            <div className='space-y-2 rounded-lg border p-4'>
              ...
              <p className='text-muted-foreground text-xs'>AI suggested</p>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <CardContent className='space-y-6'>
            ...
            <div>
              <div className='mb-2 flex items-center justify-between'>
                ...
                <Badge
                  className={
                    getMarketPositionLabel(analytics.market_position).color
                  }
                >
            ...
            <div>
              <div className='mb-2 flex items-center justify-between'>
                ...
                <span
                  className={`text-sm font-medium ${getConfidenceColor(analytics.confidence_score)}`}
                >
                  {analytics.confidence_score}%
                </span>
              </div>
              <Progress value={analytics.confidence_score} className='h-2' />
              <p className='text-muted-foreground mt-1 text-xs'>
                {analytics.confidence_score >= 80
                  ? 'High confidence'
                  : analytics.confidence_score >= 60
                    ? 'Medium confidence'
                    : 'Low confidence'}
              </p>
            </div>
          ...
          <CardContent className='space-y-4'>
            ...
            <div className='flex items-center justify-between rounded-lg border p-4'>
              <div className='flex items-center gap-3'>
                ...
                <div>
                  <p className='text-sm font-medium'>Products Growth</p>
              ...
              <Badge variant='outline'>
                {analytics.trends.products_growth}
              </Badge>
            </div>
