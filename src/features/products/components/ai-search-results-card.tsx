...
import type { ProductSearchResponse, ProductWithLink, ProductWithMultiLinks } from '../types/product-ai.types';
...
export function AISearchResultsCard({ data, isLoading, onUseUrl }: AISearchResultsCardProps) {
  ...
  const isProductWithLink = (product: ProductWithLink | ProductWithMultiLinks): product is ProductWithLink => {
    return 'url' in product;
  };

  const isProductWithMultiLinks = (product: ProductWithLink | ProductWithMultiLinks): product is ProductWithMultiLinks => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>AI Search Results</CardTitle>
        <CardDescription>
          {data.total_found} products found • {data.recommended_products.length} recommended
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {data.ai_analysis && (
          <div className="p-4 bg-muted rounded-lg">
            ...
            <p className="text-sm text-muted-foreground whitespace-pre-line">{data.ai_analysis}</p>
          </div>
        )}
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-right text-xs w-[120px]">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
                  ...
                  <TableCell className="text-xs">
                    {isProductWithLink(product) ? (
                      ...
                      <div className="space-y-0.5">
                        ...
                        {product.urls.tiki && (
                          <div className="flex items-center gap-1">
                            <Badge variant="outline" className="text-[10px] px-1 py-0">T</Badge>
                            <a
                          ...
                          {product.urls.shopee && (
                            <>
                              ...
                              <Button
                                ...
                                size="sm"
                                className="h-7 w-7 p-0"
                                onClick={() => handleCopyUrl(product.urls.shopee!)}
                              ...
                              <Button
                                ...
                                size="sm"
                                className="h-7 w-7 p-0"
                                onClick={() => handleOpenUrl(product.urls.shopee!)}
                                title="Open Shopee"
                              >
                                <ExternalLink className="h-3 w-3" />
                              </Button>
                          ...
                          {product.urls.lazada && (
                            <>
                              ...
                              <Button
                                ...
                                size="sm"
                                className="h-7 w-7 p-0"
                                onClick={() => handleCopyUrl(product.urls.lazada!)}
                              ...
                              <Button
                                ...
                                size="sm"
                                className="h-7 w-7 p-0"
                                onClick={() => handleOpenUrl(product.urls.lazada!)}
                                title="Open Lazada"
                              >
                                <ExternalLink className="h-3 w-3" />
                              </Button>
                          ...
                          {product.urls.tiki && (
                            <>
                              ...
                              <Button
                                ...
                                size="sm"
                                className="h-7 w-7 p-0"
                                onClick={() => handleCopyUrl(product.urls.tiki!)}
                                title="Copy Tiki URL"
                              >
                                <Copy className="h-3 w-3" />
                              </Button>
                              <Button
                                ...
                                size="sm"
                                className="h-7 w-7 p-0"
                                onClick={() => handleOpenUrl(product.urls.tiki!)}
                                title="Open Tiki"
                              >
                                <ExternalLink className="h-3 w-3" />
                              </Button>
