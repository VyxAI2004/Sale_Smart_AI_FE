...
export class ReviewAnalysisApi {
   ...
   */
  static async getStatistics(productId: string): Promise<AnalysisStatisticsResponse> {
   ...
   * Get analysis detail
   */
  static async getById(productId: string, analysisId: string): Promise<ReviewAnalysis> {
