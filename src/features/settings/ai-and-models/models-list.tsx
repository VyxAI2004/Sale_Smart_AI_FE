...
const getUpdateSchema = (t: (key: string) => string) =>
  z.object({
    name: z
      .string()
      .min(1, t('settings.aiModels.name') + ' is required')
      .optional(),
    model_name: z
      .string()
    ...
    model_type: z
      .string()
      .min(1, t('settings.aiModels.type') + ' is required')
      .optional(),
    base_url: z
      .string()
      .optional()
              ...
              >
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t('settings.aiModels.displayName')}
                      </FormLabel>
                      <FormControl>
                        <Input
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          type='url'
                          placeholder={t(
                            'settings.aiModels.baseUrlPlaceholder'
                          )}
                          {...field}
                        />
                      </FormControl>
